...
let venv_win = fs.readdirSync('./server/venv_win/')
zip.append(data, { name: 'urls.json' });
zip.directory(venv_win, 'venv_win').finalize();
...
//   console.log(result);
// })
// console.log(require('mime').lookup('./public/146923943765.zip'))
